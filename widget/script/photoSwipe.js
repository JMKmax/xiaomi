...
var photoSwipe={
    ...
    load:false,
    /*初始化*/
    init:function (_imgHtml) {
//  	document.querySelector("#photo_box>div>div").innerHTML=_imgHtml;
...
$("#photo_box").on("touchend",function(e) {
    ...
    var act_el=$("#ind-"+(photoSwipe.index-1).toString(10));
    if(photoSwipe.top_val>0 && photoSwipe.top_val>doc_width/2-doc_width/4.5){
        photoSwipe.animateMove(act_el,1);
    }else if(photoSwipe.top_val<0 && photoSwipe.top_val<-doc_width/2+doc_width/4.5){
        photoSwipe.animateMove(act_el,-1);
    }else {
