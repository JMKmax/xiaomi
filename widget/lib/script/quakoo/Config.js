...
var Config = (function(_super){
    ...
    //解绑第三方账号
    _super.prototype.getUrl_web_user_unBindingAuthKey = function(){return this.serverUrl + '/web/user/unBindingAuthKey';};
    ...
    _super.prototype.getUrl_model_getHotSearchRecord = function(){return this.serverUrl + '/model/getHotSearchRecord';};
    ...
    // 个人主页中作品列表
    _super.prototype.getUrl_model_getUserHomeContentPager = function(){return this.serverUrl + '/model/getUserHomeContentPager';};
    //模特自己设置 加自己微信的价钱
    ...
    // 获取支付宝参数
    _super.prototype.getUrl_wallet_aliAuthParam = function(){return this.serverUrl + '/wallet/aliAuthParam';};
    // - 绑定支付宝、微信
    ...
    // 模特改变订单状态
    _super.prototype.getUrl_model_modelChangeOrderStatus = function(){return this.serverUrl + '/model/modelChangeOrderStatus';};
...
var App = (function (_super) {
    ...
    _super.prototype.initShowGuide=function(callback){
        //判断是否第一次打开
        var showGuide = quakooDb.getItem('isShowGuide');
        if (!showGuide) {
            quakooApp.openFrame('guide','html/guide/guide.html',{},0,0);
        } else {
            callback();
        }
    };
